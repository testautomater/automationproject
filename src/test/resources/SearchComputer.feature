...
Feature: Checking feature of Searching computer
  ...
  Scenario: As a user I want to search for a computer
    ...
    And User enters computer name "APTECH-READ"
    ...
    When User enters computer name "APTECH-READ" in search box
    And User submit search button
    Then User finds the Computer name "APTECH-READ" in result list
